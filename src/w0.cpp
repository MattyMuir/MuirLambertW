...
{
	// Rational approximation coefficients for algorithm 2, index 1, order 9/8
	static constexpr double P[] = {
...
{
	// Rational approximation coefficients for algorithm 2, index 2, order 9/8
	static constexpr double P[] = {
...
{
	// Rational approximation coefficients for algorithm 2, index 3, order 10/8
	static constexpr double P[] = {
