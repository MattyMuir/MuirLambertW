...
{
    static constexpr double Y = 5.00126481056213379e-02;
    ...
    double d = x + 0.367879441171442321595523770161460867445811;
...
{
    static constexpr double Y = 3.49680423736572266e-01;
    static constexpr double P[] = {
...
{
    static constexpr double Y = 1.20359611511230469e+00;
    static constexpr double P[] = {
...
double MuirW0v2(double x)
{
    ...
    if (x < 9897.12905874)
    {
        if (x < 6)
        {
            if (x < 2) return Approx7(x);
            return Approx8(x);
        }
        if (x < 18) return Approx9(x);
        return Approx10(x);
    }
    if (x < 2.6881171e+43)
    {
        if (x < 7.896296e+13) return Approx11(x);
        return Approx12(x);
    }
    return Approx13(x);
}