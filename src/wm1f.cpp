...
static inline __m256 FirstApprox(__m256 lx)
{
	...
	static constexpr float P[] = {
		-0.9999947770248371,-1.4142802274833077,-0.6663468462971003,-0.07936575583288796,0.016000547102702947,-0.0024352660263118973,0.00024032743757630923,-1.1250272634544634e-05
	};
...
{
	// Rational approximation coefficients for algorithm 8, index 3, order 4/3
	static constexpr float P[] = {
