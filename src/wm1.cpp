...
{
    // Polynomial approximation coefficients for algorithm 6, index 1, order 18
	static constexpr double P[] = {
...
{
    // Rational approximation coefficients for algorithm 6, index 2, order 8/6
	static constexpr double P[] = {
...
{
    // Rational approximation coefficients for algorithm 6, index 3, order 9/6
    static constexpr double P[] = {
